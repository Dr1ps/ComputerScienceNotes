...
Non esiste un paradigma migliore degli altri, dipende dalla situazione.\\
Molti programmi possono usare per sottoproblemi approcci diversi (\textbf{multiparadigma}).
\subsection{Paradigma imperativo}
Il \textbf{paradigma imperativo} prevede istruzioni dirette, senza funzioni.
