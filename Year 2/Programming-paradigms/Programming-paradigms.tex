...
Per attualizzare questa segnatura si fa cosi:
\[
(\lambda x.x)z = z
\]
...
\]
\[
(\lambda x. \lambda y.zy)k = (\lambda y.zy)k
\]
...
Una \textbf{variabile legate} a un $\lambda$ sono quelle che fanno parte di una lambda espressione, ovvero una dichiarazione (parametri formali).\\
Le \textbf{variabili libere} invece corrispondono al contrario, come i parametri attuali, le variabili non enunciate da un $\lambda$, queste sono definite dall'insieme:
\[
FV
\]
