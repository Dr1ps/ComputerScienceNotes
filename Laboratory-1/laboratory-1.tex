...
I modificatori d'accesso permettono appunto di modificare la visibilità di un attributo di una classe e sono:
\begin{itemize}
...
\subsection{Cosa sono le espressioni regolari (Regex)?}
