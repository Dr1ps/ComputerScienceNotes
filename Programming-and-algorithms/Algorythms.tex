...
\section{Grafi}
\subsection{Grafi come liste di adiacenza}
Un grafo può essere rappresentato come una lista di liste, si dice in tal caso che è rappresentato con \textbf{liste di adiacenza}.\\
La lista principale contiene gli stati, le liste associate agli stati invece elencano gli stati vicini (queste liste non sono ordinate).\\
